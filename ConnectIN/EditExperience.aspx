<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditExperience.aspx.cs" Inherits="ConnectIN.EditExperience" %>
...
<head runat="server">
    ...
    <title>Edit Experience | ConnectIN</title>
                                        ...
                                        <div class="col-md-10">
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    <asp:Label class="label label-info" ID="label1" runat="server" Text="Institution"></asp:Label>
                                                    <br />
                                                    ...
                                                    <br />
                                                    <asp:Label class="label label-info" ID="label2" runat="server" Text="Title"></asp:Label>
                                                    <br />
                                                    <asp:TextBox ID="txtname" Font-Size="Larger" Font-Bold="true" TextMode="SingleLine" Height="60" Width="800" runat="server"></asp:TextBox>
                                                    <br />
                                                    <asp:Label class="label label-info" ID="label4" runat="server" Text="Type"></asp:Label>
                                                    <br />
                                                    <asp:TextBox ID="txttype" Font-Size="Larger" Font-Bold="true" TextMode="SingleLine" Height="60" Width="800" runat="server"></asp:TextBox>
                                                    <br />
                                                    <asp:Label class="label label-info" ID="label_addEducation_SDate" runat="server" Text="Start Date"></asp:Label>
                                                    <%--<br />--%>
                                                    <asp:TextBox ID="Experience_SDate" runat="server" Width="100"></asp:TextBox>
                                                    ...
                                                    <%--<br />--%>
                                                    <asp:TextBox ID="Experience_EDate" runat="server" Width="100"></asp:TextBox>


                                                    <asp:Calendar ID="Calendar2" runat="server" OnSelectionChanged="Calendar2_SelectionChanged"></asp:Calendar>
                                                    <br />
                                                    <asp:Label class="label label-info" ID="label3" runat="server" Text="Description"></asp:Label>
                                                    <br />
                                                    <asp:TextBox ID="txtDescription" Font-Size="Medium" TextMode="MultiLine" Height="200" Width="800" runat="server"></asp:TextBox>
                                                    <hr />

                                                    <asp:Button Class="btn btn-primary btn-just-icon" ID="Experiencebtn_edit" Text="Save" Width="150" Height="50px" runat="server" OnClick="Experiencebtn_edit_Click" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
