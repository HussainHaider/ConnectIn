<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditProject.aspx.cs" EnableSessionState="true" Inherits="ConnectIN.EditProject" %>
...
<head runat="server">
    ...
    <title>Edit Project | ConnectIN</title>
                                        ...
                                        <div class="col-md-10">
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    ...
                                                    <hr />
                                                    <asp:Button Class="btn btn-primary btn-just-icon" ID="projectbtn_edit" Text="Save" Width="150" Height="50px" runat="server" OnClick="projectbtn_edit_Click" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
