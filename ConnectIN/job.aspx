<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="job.aspx.cs" Inherits="ConnectIN.job" %>
                                        ...
                                        <div class="col-md-10">
                                            <div class="card">
                                                <div class="card-content">
                                                    <asp:Panel ID="paneljob" runat="server"></asp:Panel>
                                                    <hr />
                                                </div>
                                            </div>
                                        </div>
