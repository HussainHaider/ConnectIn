<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditAwards.aspx.cs" Inherits="ConnectIN.EditAwards" %>
...
<head runat="server">
    ...
    <title>Edit Honors&Award | ConnectIN</title>
                                            ...
                                            <div class="col-md-10">
                                                <div class="card">
                                                    <div class="card-header" data-background-color="blue">
                                                        <h3 class="title">Edit Awards</h3>
                                                        <%--                                <p class="category">Complete your profile</p>--%>
                                                    </div>
                                                    <div class="card-content">
                                                        <asp:TextBox ID="txttitle" Font-Size="Larger" Font-Bold="true" TextMode="SingleLine" Height="60" Width="800" runat="server"></asp:TextBox>
                                                        <br />
                                                        <asp:TextBox ID="txtDate" Font-Size="Larger" Font-Bold="true" TextMode="SingleLine" Height="60" Width="800" runat="server"></asp:TextBox>
                                                        <br />

                                                        <asp:TextBox ID="txtDescription" Font-Size="Medium" TextMode="MultiLine" Height="200" Width="800" runat="server"></asp:TextBox>
                                                        <hr />
                                                        <asp:Button Class="btn btn-primary btn-just-icon" ID="Awardbtn_edit" Text="Save" Width="150" Height="50px" runat="server" OnClick="Awardbtn_edit_Click" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
