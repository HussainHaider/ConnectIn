<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchProfile.aspx.cs" EnableSessionState="true" Inherits="ConnectIN.SearchProfile" %>
...
<head runat="server">
    ...
    <title>Search Profile|ConnectIN</title>
                                        ...
                                        <div class="col-md-10">
                                            <div class="card">
                                                ...
                                                <div class="text-right">
                                                    <asp:Button runat="server" Text="Send Request" class="btn btn-primary btn-round" ID="Send_requestbtn" OnClick="Send_requestbtn_Click" />
                                                    <asp:Button runat="server" Text="Disconnect" class="btn btn-primary btn-round" ID="Disconnect" OnClick="Disconnect_Click" />
                                                </div>
